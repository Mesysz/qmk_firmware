...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_LCTL,        KC_LGUI, LM(1, MOD_LALT),                            KC_SPC,                    KC_RALT, MO(_WITH_FN),	KC_LEFT,         KC_DOWN, KC_RGHT
    ),
    [_WITH_FN] = LAYOUT(
    ...
    [_RGB_CONFIG] = LAYOUT(
        _______, RGB_M01,  RGB_M02, RGB_MO3, RGB_M01, RGB_M05, RGB_M06, RGB_M07, RGB_M08, RGB_M09, RGB_M10, _______, _______,  KC_DEL,
        _______, RGB_TOG,  RGB_SPI, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_MOD, _______, _______, _______, RESET,
